...
unix{
 ...
 LIBS += -lYVRTCEngine  -lYVRTCCore -lyuv -lspeexdsp -lopus -lopenh264 -lusrsctp -lpthread -lasound -ldl
    #openssl
...
win32{
    ...
    LIBS += -lYVRTCEngine  -lYVRTCCore -lyuv -lspeexdsp -lopenh264 -lopus -lusrsctp -lavutil -lavcodec -lwinmm -ldmoguids -lole32 -lStrmiids
